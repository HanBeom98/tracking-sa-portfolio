...
async function initLayout() {
    ...
    if (body) {
        ...
        if (savedTheme === 'dark') {
            ...
            if (themeToggle) { // Ensure button exists before changing icon
                themeToggle.innerHTML = '☀️'; // Moon icon for light mode
            }
        }
    }
        ...
        themeToggle.addEventListener('click', () => {
            if (body) { // Defensive check for body
                ...
                if (body.classList.contains('dark-mode')) {
                    ...
                    themeToggle.innerHTML = '🌙'; // Change to sun for dark mode
                } else {
                    localStorage.setItem('theme', 'light');
                    themeToggle.innerHTML = '☀️'; // Change to moon for light mode
                }
            }
        });
    }
